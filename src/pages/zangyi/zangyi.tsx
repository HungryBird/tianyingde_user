...
export default class Binyi extends Mixins {
  ...
  render() {
    return (
      <View className='zangyi page-main'>
        <Nav title='葬仪服务' />
          ...
          <View 
            ...
            <View className='text-wrap'>
              <ol>
                ...
                <li>葬仪服务已经完成，用户档案进入CRM系统，逢年过节，业务员免费慰问提醒</li>
              </ol>
            </View>
          </View>
          ...
          <View className='modal-form-wrap'>
            ...
            <View className='bottom-content'>
              <Form onSubmit={this.submit.bind(this)} onReset={this.reset.bind(this)}>
                ...
                <Btn formType='submit' text='支付' type='primary' style='margin: 30px auto;margin-bottom: 10px;width: 50%;' round />
              </Form>
            </View>
          </View>
        </Mask>
